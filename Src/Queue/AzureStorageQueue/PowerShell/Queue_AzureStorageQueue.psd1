#
# Module manifest for module 'Queue_AzureStorageQueue'
#
...
RootModule = 'Queue_AzureStorageQueue.psm1'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 
               '''Queue_AzureStorageQueue'' ''SovereignTrust.Adapters'' ''SovereignTrust'' ''Adapters'' ''Public'' ''Azure'' ''SDA'' ''BDDB'''
