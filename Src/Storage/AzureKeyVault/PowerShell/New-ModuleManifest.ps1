...
New-ModuleManifest -Path ./Storage_AzureKeyVault.psd1 `
  ...
  -Tags "'Storage_AzureKeyVault' 'SovereignTrust.Adapters' 'SovereignTrust' 'Adapters' 'Public' 'Core' 'SDA' 'BDDB'" `
  -LicenseUri 'https://opensource.org/licenses/MIT' `
  -ProjectUri 'https://github.com/SiliconDreamArtists/Storage_AzureKeyVault' `
