#
# Module manifest for module 'Network_DiscordBot'
#
...
RootModule = 'Network_DiscordBot.psm1'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 
               '''Network_DiscordBot'' ''SovereignTrust.Adapters'' ''SovereignTrust'' ''Adapters'' ''Public'' ''Azure'' ''SDA'' ''BDDB'''
